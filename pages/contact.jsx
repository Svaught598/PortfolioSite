        ...
        <main className="w-11/12 md:w-6/12 mx-auto h-50">
          ...
          <div className={clsx("flex flex-col space-y-10 p-5 mb-5 rounded-xl shadow-xl", card, delayEntrance)}>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <IconLink destination="somewhere.com" icon={ faLinkedin } darkMode={ darkMode }/>
              <IconLink destination="somewhere.com" icon={ faGithub } darkMode={ darkMode }/>
              <IconLink destination="somewhere.com" icon={ faTwitter } darkMode={ darkMode }/>
              <IconLink destination="somewhere.com" icon={ faDiscord } darkMode={ darkMode }/>
            </div>
          </div>
